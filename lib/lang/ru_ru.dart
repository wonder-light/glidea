const Map<String, String> ru = {
  ...
  'email': 'Email',
  'showComment': 'Показывать комментарии',
  ...
  'platform': 'Платформа',
  'commentPlatform': 'Платформа',
  'topArticles': 'Закрепить запись',
  'acquiesce': 'По умолчанию',
  ...
  'saveConfig': 'Пожалуйста, сохраните конфигурацию, чтобы она подействовала',
